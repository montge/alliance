...
public class NitfParserServiceImpl implements NitfParserService {
  ...
  public NitfSegmentsFlow parseNitf(InputStream inputStream, Boolean allData)
    ...
    if (allData != null && allData) {
      return new NitfParserInputFlowImpl().inputStream(inputStream).allData();
    }

    return new NitfParserInputFlowImpl().inputStream(inputStream).headerOnly();
  }
  ...
  public NitfSegmentsFlow parseNitf(File nitfFile, Boolean allData)
    ...
    if (allData != null && allData) {
      return new NitfParserInputFlowImpl().file(nitfFile).allData();
    }

    return new NitfParserInputFlowImpl().file(nitfFile).headerOnly();
  }
